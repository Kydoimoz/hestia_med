    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Hestia Med ist ein modernes Praxismanagement-System für Allgemeinmediziner und niedergelassene Ärzte. Es hilft, die Patientenverwaltung, Terminplanung und tägliche administrative Aufgaben zu optimieren. Mit den neuesten Technologien entwickelt, gewährleistet es eine sichere Datenspeicherung, Skalierbarkeit und einfachen Zugriff von jedem Gerät aus.
            </p>
            ...
            <div className="flex flex-col items-start space-x-3 space-y-3 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                ...
                Testen Sie kostenlos unsere Software!
              </Link>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-center w-full lg:w-1/2">
          ...
          <div id="threejs_left_container" style={{marginTop: "-300px", width: "700px", height: "400px"
  }}><canvas></canvas></div>
          </div>
        </div>
      </Container>
      <Container>
        <div className="flex flex-col justify-center">
          ...
          Vertrauen von über <span style={{color:"#ae9b7f"}}>2000+</span> Kunden
          </div>
